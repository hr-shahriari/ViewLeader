...
export class AnnotationManager {
    ...
    private render(): void {
        ...
        for (const ann of this.annotations.values()) {
            ...
            bg.setAttribute('x', String(recX))
            bg.setAttribute('y', String(recY))
            bg.setAttribute('width', String(recW))
            bg.setAttribute('height', String(recH))
            bg.setAttribute('fill', backColor)
            bg.setAttribute('fill-opacity', backOpacity)
            bg.setAttribute('rx', String(borderRad))
            group.appendChild(bg)
            text.setAttribute('x', String(recX + padding))
            text.setAttribute('y', String(recY + padding))
